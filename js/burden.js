/* The landing page's flood-burden figure: one YEAR at a time, 2012 onwards.
   ...
   The cost is that quiet years look quiet, which is the point. The axis carries
   no numbers: this is an illustration under the hero, not a chart to read
   values off, and the dashboard is where the counts are given.
...
(function () {
  ...
  /* The month bars share one axis across every year, so bar heights stay
     comparable between frames. The maximum is derived, never written down. */
